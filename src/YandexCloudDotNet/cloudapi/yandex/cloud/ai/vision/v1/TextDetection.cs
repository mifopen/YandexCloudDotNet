...
namespace Yandex.Cloud.Ai.Vision.V1 {
  ...
  internal static partial class TextDetectionReflection {
    ...
    static TextDetectionReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "bmd1YWdlX2NvZGUYASABKAkSEgoKY29uZmlkZW5jZRgCIAEoAUJGWkRnaXRo",
            "dWIuY29tL3lhbmRleC1jbG91ZC9nby1nZW5wcm90by95YW5kZXgvY2xvdWQv",
            "YWkvdmlzaW9uL3YxO3Zpc2lvbmIGcHJvdG8z"));
  ...
  #region Messages
  internal sealed partial class TextAnnotation : pb::IMessage<TextAnnotation> {
  ...
  internal sealed partial class Block : pb::IMessage<Block> {
  ...
  internal sealed partial class Word : pb::IMessage<Word> {
    ...
    public static partial class Types {
      internal sealed partial class DetectedLanguage : pb::IMessage<DetectedLanguage> {
