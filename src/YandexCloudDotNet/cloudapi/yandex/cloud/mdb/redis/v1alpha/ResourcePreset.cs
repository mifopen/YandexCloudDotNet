...
namespace Yandex.Cloud.Mdb.Redis.V1Alpha {
  ...
  /// <summary>Holder for reflection information generated from yandex/cloud/mdb/redis/v1alpha/resource_preset.proto</summary>
  internal static partial class ResourcePresetReflection {

    #region Descriptor
    /// <summary>File descriptor for yandex/cloud/mdb/redis/v1alpha/resource_preset.proto</summary>
    ...
    static ResourcePresetReflection() {
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Yandex.Cloud.Mdb.Redis.V1Alpha.ResourcePreset), global::Yandex.Cloud.Mdb.Redis.V1Alpha.ResourcePreset.Parser, new[]{ "Id", "ZoneIds", "Cores", "Memory" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  internal sealed partial class ResourcePreset : pb::IMessage<ResourcePreset> {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::Yandex.Cloud.Mdb.Redis.V1Alpha.ResourcePresetReflection.Descriptor.MessageTypes[0]; }
    }
